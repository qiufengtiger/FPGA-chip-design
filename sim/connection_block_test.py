...
async def test_cb(dut):
	...
	assert out_0 == tracks_0[out_config[0]], "out_0 expecting %d, getting %d" % (tracks_0[out_config[0]], out_0)
	assert out_1 == tracks_1[out_config[1]], "out_1 expecting %d, getting %d" % (tracks_1[out_config[1]], out_1)
