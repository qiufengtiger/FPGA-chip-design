...
async def test_sb_edge(dut):
	...
	left_select = [random.randint(0, 1) for i in range(4)]
	right_select = [random.randint(0, 1) for i in range(4)]
	top_select = [random.randint(0, 1) for i in range(4)]

	left_binary = int_list_to_bitstream(left_select, 1)
	right_binary = int_list_to_bitstream(right_select, 1)
	top_binary = int_list_to_bitstream(top_select, 1)
	...
	print(left_select + right_select + top_select)

	bitstream = left_binary + right_binary + top_binary;
	print(bitstream)
	...
	# golden result
	left_out_dict_0 = {0: top_in[1], 1: right_in[0]}
	left_out_dict_1 = {0: top_in[2], 1: right_in[1]}
	left_out_dict_2 = {0: top_in[3], 1: right_in[2]}
	left_out_dict_3 = {0: top_in[0], 1: right_in[3]}
	...
	right_out_dict_0 = {0: top_in[2], 1: left_in[0]}
	right_out_dict_1 = {0: top_in[1], 1: left_in[1]}
	right_out_dict_2 = {0: top_in[0], 1: left_in[2]}
	right_out_dict_3 = {0: top_in[3], 1: left_in[3]}
	...
	top_out_dict_0 = {0: right_in[2], 1: left_in[3]}
	top_out_dict_1 = {0: right_in[1], 1: left_in[0]}
	top_out_dict_2 = {0: right_in[0], 1: left_in[1]}
	top_out_dict_3 = {0: right_in[3], 1: left_in[2]}
